...
HD_PWD='/home/caccolillo/Downloads/test_filter_colin/vivado_tb/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter.tcl
